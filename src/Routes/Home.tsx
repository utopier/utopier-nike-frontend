  ...
  return (
    <HomeContainer>
        ...
        <div className="home-img-container">
                ...
                <div className="home-img-container__text">
                    <p>나이키 에어 <br/>베이퍼 맥스 EVO</p>
                    <p>클래식한 에어맥스 시리즈를 <br/>리믹스하여
                        더욱 볼드해진 <br/>나이키 에어 베이퍼맥스 EVO를 만나보세요.
                    </p>
                </div>
                <div className="home-img-container__btn">
                    <button>구매하기</button>
            ...
            <div className="home-img-container">
                ...
                <div className="home-img-container__text">
                    <p>나이키 에어맥스 비바</p>
                    <p>맥스 에어 유닛과 아이코닉한 디자인의<br/> 비바와 함께
                        시선을 압도하는 <br/>세련된 스타일을 연출해보세요.
                    </p>
                </div>
                <div className="home-img-container__btn">
                    <button>구매하기</button>
            ...
            <div className="weekend-style">
                ...
                <div className="weekend-style__text">
                    <p>스프링 재킷 스타일</p>
                    <p>봄을 위한 여성 재킷 제품들과 함께 <br/> 레이어드 룩을 완성해보세요.</p>
                </div>
                <div className="weekend-style__btn">
                    <button>구매하기</button>
                    <button>더 많은 스타일링 보기</button>
            ...
            <div className="home-img-container">
                ...
                <div className="home-img-container__text">
                    <p>조던 MA2</p>
                    <p>최상의 편안함과 감각적인 스타일의<br/> 조던 MA2를 만나보세요.</p>
                </div>
                <div className="home-img-container__btn">
                    <button>구매하기</button>
                </div>
